...
const (
	...
	CategoryService_CreateCategoryBiStream_FullMethodName = "/pb.CategoryService/CreateCategoryBiStream"
...
type CategoryServiceClient interface {
	...
	CreateCategoryBiStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryRequest, Category], error)
...
func (c *categoryServiceClient) CreateCategoryBiStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryRequest, Category], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], CategoryService_CreateCategoryBiStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryBiStreamClient = grpc.BidiStreamingClient[CreateCategoryRequest, Category]
...
type CategoryServiceServer interface {
	...
	CreateCategoryBiStream(grpc.BidiStreamingServer[CreateCategoryRequest, Category]) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryBiStream(grpc.BidiStreamingServer[CreateCategoryRequest, Category]) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryBiStream not implemented")
}
...
func _CategoryService_CreateCategoryBiStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryBiStream(&grpc.GenericServerStream[CreateCategoryRequest, Category]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryBiStreamServer = grpc.BidiStreamingServer[CreateCategoryRequest, Category]
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryBiStream",
			Handler:       _CategoryService_CreateCategoryBiStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
